    ...
    <>
      <PageContainer className="items-start justify-start">
        <div className="w-full flex justify-start items-start">
          ...
          <div className="min-w-[400px] flex justify-center items-center flex-col text-center sticky top- right-0">
            <span className="uppercase dark:text-white text-zinc-900">
              share posts
            </span>
